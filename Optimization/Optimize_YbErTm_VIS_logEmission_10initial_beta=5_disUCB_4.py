...
LOG_DEST = "../saved_data/fws_YbErTm_VIS_10initial_logEmission_beta=5_disUCB_4.csv"
FLAG_DEST = "../saved_data/flag_YbErTm_VIS_10initial_logEmission_beta=5_disUCB_4.csv"
def check_last_run():
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults_YbErTm_VISlogEmission_beta=5_10inits_4.cfg",
