...
LOG_DEST = "../saved_data/fws_YbErTm_VIStoUV_20initial_logEmission_beta=5_disUCB.csv"
FLAG_DEST = "../saved_data/flag_YbErTm_VIStoUV_20initial_logEmission_beta=5_disUCB.csv"
def check_last_run():
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults_YbErTm_VIStoUVlogEmission_beta=5_20inits_5.cfg",
