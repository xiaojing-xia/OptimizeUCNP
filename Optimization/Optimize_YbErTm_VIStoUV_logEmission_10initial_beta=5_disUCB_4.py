...
LOG_DEST = "../saved_data/fws_YbErTm_VIStoUV_10initial_logEmission_beta=5_disUCB_4.csv"
FLAG_DEST = "../saved_data/flag_YbErTm_VIStoUV_10initial_logEmission_beta=5_disUCB_4.csv"
def check_last_run():
...
def get_data_botorch(data_file, from_cloud = True):
    ...
    # labels
    train_y = torch.from_numpy(my_data[:, 7]).unsqueeze(-1)
    # best observation
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults_YbErTm_VIStoUVlogEmission_beta=5_10inits_4.cfg",
