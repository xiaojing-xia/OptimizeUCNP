...
LOG_DEST = "../saved_data/fws_YbEr_UV_10initial_logEmission_beta=5_disUCB.csv"
FLAG_DEST = "../saved_data/flag_YbEr_UV_10initial_logEmission_beta=5_disUCB.csv"
def check_last_run():
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults_YbEr_UV_logEmission_beta=5.cfg",
