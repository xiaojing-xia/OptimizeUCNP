...
LOG_DEST = "../saved_data/fws_YbErTm_VIS_20initial_logEmission_beta=5_disUCB.csv"
FLAG_DEST = "../saved_data/flag_YbErTm_VIS_20initial_logEmission_beta=5_disUCB.csv"
def check_last_run():
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults_YbErTm_logEmission_beta=5.cfg",
